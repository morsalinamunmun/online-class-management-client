...
const Navbar = () => {
    ...
    const menus = <>
        ...
        {
            user?
            <li><NavLink to='/dashboard' className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "text-teal-300" : ""}>Dashboard</NavLink></li>
             : ' '
        }
        ...
        <div className="navbar fixed z-10 text-white bg-teal-500 bg-opacity-30">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-teal-500 rounded-box w-52 ">
                        {menus}
                    </ul>
                </div>
